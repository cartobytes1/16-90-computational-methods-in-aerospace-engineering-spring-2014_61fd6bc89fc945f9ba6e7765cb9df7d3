...
menu:
  leftnav:
    identifier: 2f081eee0a8710731d700665eba82887
    name: Syllabus
    weight: 10
title: Syllabus
type: course
uid: 2f081eee0a8710731d700665eba82887
...
You could begin by completing all the readings in a Unit, then work through all of the Unit's sample problems in sequence, and then finally do all of the [homework assignments]({{< baseurl >}}/sections/assignments).
